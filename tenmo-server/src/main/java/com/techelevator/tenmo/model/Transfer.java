...
public class Transfer {
    ...
    // below constructor wasnt used line 46-61 wasnt used
    // re-did above to get specifically what we needed

    public Transfer(){};
    private Transfer_Status status;
    private Transfer_Type type;
    //Constructor
    public Transfer(@NotNull(message = "This should not be empty") long transfer_Id, long transfer_Type_Id, long transfer_Status_Id, long account_from,
                    double account_to, String user_From, String user_To, Transfer_Status status, Transfer_Type type, @Positive double amount) {
